...
def file_based_convert_examples_to_features_for_inews(
  ...
  writer = tf.io.TFRecordWriter.TFRecordWriter(output_file)
  num_example = 0
  ...
  tf.compat.v1.logging.info("feature num: %s", num_example)
  writer.close()
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  with tf.compat.v1.variable_scope("loss"):
    ...
    # print("##cross entropy loss is used...."); tf.compat.v1.logging.info("##cross entropy loss is used....")
    # t1=0.9 #t1=0.90
    # t2=1.05 #t2=1.05
    ...
    # tf.compat.v1.logging.info("per_example_loss:"+str(per_example_loss.shape))
    ##############bi_tempered_logistic_loss#############################################################################
...
def main(_):
  ...
  if FLAGS.do_predict:
    ...
    with tf.compat.v1.gfile.GFile(output_predict_file_label, "w") as writer_label:
